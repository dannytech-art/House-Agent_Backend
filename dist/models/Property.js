...
function toSnakeCase(data) {
    ...
    if (data.bathrooms !== undefined)
        result.bathrooms = data.bathrooms;
    ...
    if (data.agent_type !== undefined)
        result.agent_type = data.agent_type;
    if (data.agentName !== undefined)
        result.agent_name = data.agentName;
    if (data.agent_name !== undefined)
        result.agent_name = data.agent_name;
    if (data.agentVerified !== undefined)
        result.agent_verified = data.agentVerified;
    if (data.agent_verified !== undefined)
        result.agent_verified = data.agent_verified;
...
return (data || []).map(toCamelCase);
// Legacy sync methods for backwards compatibility
findOne(predicate, (property) => boolean);
PropertyDocument | undefined;
{
    console.warn('PropertyModel.findOne is deprecated. Use async methods instead.');
    return undefined;
}
findMany(predicate, (property) => boolean);
PropertyDocument[];
{
    console.warn('PropertyModel.findMany is deprecated. Use async methods instead.');
    return [];
