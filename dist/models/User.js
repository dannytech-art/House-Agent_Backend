...
function toSnakeCase(data) {
    ...
    if (data.passwordHash !== undefined)
        result.password_hash = data.passwordHash;
    ...
    if (data.kycStatus !== undefined)
        result.kyc_status = data.kycStatus;
    ...
    if (data.walletBalance !== undefined)
        result.wallet_balance = data.walletBalance;
    if (data.streak !== undefined)
        result.streak = data.streak;
    if (data.totalListings !== undefined)
        result.total_listings = data.totalListings;
    if (data.totalInterests !== undefined)
        result.total_interests = data.totalInterests;
    if (data.responseTime !== undefined)
        result.response_time = data.responseTime;
